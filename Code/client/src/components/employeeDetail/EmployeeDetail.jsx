...
export default function EmployeeDetail() {
  ...
  const [employeeById, updateEmployeeById, isLoading] = GetEmployeeById(
    params.id
  );
  ...
  return isLoading ? (
    ...
    <Row justify="center" className="employeeContent">
      <Col span={18}>
        ...
        <Row>
          ...
          <Col span={6}>
            {employeeById.name} {employeeById.surname}
          </Col>
        </Row>
        <Row>
          ...
          <Col span={6}>
            {(() => {
              switch (employeeById.unitForEmployee) {
                case null:
                  return "Středisko neuvedeno";
                default:
                  return employeeById.unitForEmployee.name;
              }
            })()}
          </Col>
        </Row>
              ...
              ({ originalName, type, id }) => (
                <Row key={id}>
                  ...
                  <Col span={4}>
                    <Button
                      type="primary"
                      onClick={() => documents.downloadDocumentById(id)}
                      shape="round"
